...
public class Solution {
  ...
  public static void main(String[] args) {
    ...
    scanner.close();
    BigInteger result = nextLargestNumber(inputNumber);
  ...
  /**
   * Finds the next largest integer to the input number by rearanging the digits of it.
   *
   * @return An integer representing the next largest integer to the input number. If it is not
   *     possible to rearrange the digits for a larger integer, then the input number is returned.
   */
  public static BigInteger nextLargestNumber(BigInteger inputNumber) {
   ...
   *
   * <p>Example: 12187465 '4' => digit with least 'place value' and 'numeric value' less than the
   * 'numeric value' of its direct neighbour to the right.
   *
   * @return A non-negative integer, representing the index of the found digit. If not such digit is
   *     found, it returns '-1';
   */
  ...
  /**
   * Having steblished the left swap digit, find the most suitable right swap digit.
   *
   * <p>The most suitable swap digit to the right is this digit where: 'left swap digit' < 'digit to
   * the right' and 'digit to the right' - 'left swap digit' is minimum.
   *
   * <p>Example: 112651 => leftSwap: 2, (6-2)=4, (5-2)=1, rightSwap: 5.
   *
  ...
  /**
   * Interchanges the places of the left and right swap digits. Then sorts in increasing order all
   * the digits after the swapped digit to the left.
   *
   * <p>Example: 112651 => leftSwap: 2, rightSwap: 5. after swap: 115621, after sort: 115126
   *
  ...
  private static String rearrangeNumber(int index_leftSwap, int index_rightSwap) {
    ...
    // Append to result all the digits after after the swapped digit to the left, in increasingn
    // order.
